var frbt1 = document.querySelector("#fr-btn-1");
var fobt1 = document.querySelector("#fo-btn-1");
var tibt1 = document.querySelector("#ti-btn-1");
var nrbt1 = document.querySelector("#nr-btn-1");

var frbt2 = document.querySelector("#fr-btn-2");
var fobt2 = document.querySelector("#fo-btn-2");
var tibt2 = document.querySelector("#ti-btn-2");
var nrbt2 = document.querySelector("#nr-btn-2");

var frbt3 = document.querySelector("#fr-btn-3");
var fobt3 = document.querySelector("#fo-btn-3");
var tibt3 = document.querySelector("#ti-btn-3");
var nrbt3 = document.querySelector("#nr-btn-3");

var frbt4 = document.querySelector("#fr-btn-4");
var fobt4 = document.querySelector("#fo-btn-4");
var tibt4 = document.querySelector("#ti-btn-4");
var nrbt4 = document.querySelector("#nr-btn-4");

var frbt5 = document.querySelector("#fr-btn-5");
var fobt5 = document.querySelector("#fo-btn-5");
var tibt5 = document.querySelector("#ti-btn-5");
var nrbt5 = document.querySelector("#nr-btn-5");

var frbt6 = document.querySelector("#fr-btn-6");
var fobt6 = document.querySelector("#fo-btn-6");
var tibt6 = document.querySelector("#ti-btn-6");
var nrbt6 = document.querySelector("#nr-btn-6");

var frbt7 = document.querySelector("#fr-btn-7");
var fobt7 = document.querySelector("#fo-btn-7");
var tibt7 = document.querySelector("#ti-btn-7");
var nrbt7 = document.querySelector("#nr-btn-7");

var frbt8 = document.querySelector("#fr-btn-8");
var fobt8 = document.querySelector("#fo-btn-8");
var tibt8 = document.querySelector("#ti-btn-8");
var nrbt8 = document.querySelector("#nr-btn-8");


// Set 1 ------------------------------------
frbt1.addEventListener("click", () => {
    frbt1.innerText = "In which city is Friends set?";
});
fobt1.addEventListener("click", () => {
    fobt1.innerText = "Name 5 essential food items that Vansh brings everyday.";
});
tibt1.addEventListener("click", () => {
    tibt1.innerText = "3 activities Tirth does on daily basis that starts with b";
});
nrbt1.addEventListener("click", () => {
    nrbt1.innerText = "Whose proxy does Tirth make the most?";
});
